(() => {
    ...
    function initSliders() {
        if (document.querySelector(".courses__tabs")) new swiper_core_Swiper(".courses__tabs", {
            modules: [ Scrollbar ],
            observer: true,
            observeParents: true,
            speed: 800,
        ...
        if (document.querySelector(".experts-services__slider")) new swiper_core_Swiper(".experts-services__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            pagination: {
                el: ".experts-services__pagination",
                clickable: true
            },
            breakpoints: {
                320: {
        ...
        if (document.querySelector(".autopark-services__slider")) new swiper_core_Swiper(".autopark-services__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            pagination: {
                el: ".autopark-services__pagination",
                clickable: true
            },
            breakpoints: {
                320: {
        ...
        if (document.querySelector(".motopark-services__slider")) new swiper_core_Swiper(".motopark-services__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            pagination: {
                el: ".motopark-services__pagination",
                clickable: true
            },
            breakpoints: {
                320: {
        ...
        if (document.querySelector(".news-single-blog__slider")) new swiper_core_Swiper(".news-single-blog__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".news-single-blog__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".news-single-blog__button_prev",
                nextEl: ".news-single-blog__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".experts-branches__slider")) new swiper_core_Swiper(".experts-branches__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            pagination: {
                el: ".experts-branches__pagination",
                clickable: true
            },
            breakpoints: {
                320: {
